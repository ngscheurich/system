...
do
  ...
  local function _65_()
    ...
    local servers = {bashls = {}, lexical = {cmd = {(vim.env.HOME .. "/Projects/lexical/_build/dev/package/lexical/bin/start_lexical.sh")}}, gdscript = {}, gopls = {}, kulala_ls = {}, lua_ls = {}, nil_ls = {}, rust_analyzer = {}, ts_ls = {}}
