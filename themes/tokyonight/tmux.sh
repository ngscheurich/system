...
export TMUX_COLOR_MAIN_BG=#15161e

export TMUX_COLOR_LEFT_FG=colour0
export TMUX_COLOR_LEFT_BG=colour12

export TMUX_COLOR_ACTIVE_FG=colour7
export TMUX_COLOR_ACTIVE_BG=#1a1b26

export TMUX_COLOR_SEG_1_FG=colour7
export TMUX_COLOR_SEG_1_BG=#15161e

export TMUX_COLOR_SEG_2_FG=colour2
export TMUX_COLOR_SEG_2_BG=#292e42
